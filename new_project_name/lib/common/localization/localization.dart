...
class Localization {
  ...
  Future _loadLangAsset() async {
    try {
      print('Attempting to load asset for locale: ${locale.languageCode}');
      return await rootBundle
          .loadString('assets/strings/${locale.languageCode}.json');
    } catch (_) {
      print('Fallback to default locale: ko');
      return await rootBundle.loadString('assets/strings/ko.json');
    }
  }
}
